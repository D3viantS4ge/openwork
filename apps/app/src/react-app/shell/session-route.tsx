  ...
  const surfaceProps = useMemo(() => {
    ...
    return {
      ...
      onForkAtMessage: async (messageId: string | null, sessionId: string, isCurrent: () => boolean) => {
        ...
        // Carry the source session's agent, model, and variant into the fork's
        // composer state. The fork is a new session id, so without this it
        // would fall back to the global default instead of matching the
