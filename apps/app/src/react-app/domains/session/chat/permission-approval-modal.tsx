    ...
    <AlertDialog open>
      ...
      >
        ...
        <div className="space-y-3 px-6 py-5">
          ...
          {hasMetadata ? (
            <details open className="group rounded-[18px] border border-dls-border bg-dls-surface px-4 py-3">
  ...
  return (
    <div className="overflow-hidden border-b border-dls-border bg-transparent">
        ...
        <div className="border-t border-dls-border px-4 py-3">
          ...
          {hasMetadata ? (
            <details open className="group mt-3 rounded-xl border border-dls-border bg-dls-surface px-3 py-2">
