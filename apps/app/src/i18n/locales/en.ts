...
export default {
  ...
  "panel.git_diff.changes": "Changes",
  "panel.git_diff.commits": "Commits",
  "panel.git_diff.working_changes": "Working changes",
  "panel.git_diff.history_unavailable": "History unavailable.",
  "panel.git_diff.no_commits": "No commits yet.",
  "panel.git_diff.commits_load_failed": "Couldn't load commits.",
  "panel.git_diff.commit_load_failed": "Couldn't load this commit.",
  "panel.git_diff.commit_diff_too_large": "This commit's diff is too large to preview.",
  "panel.git_diff.no_commit_changes": "No changes in this commit.",
  "panel.git_diff.loading": "Loading changes…",
  "panel.git_diff.load_failed": "Couldn’t read the repository diff.",
  "panel.git_diff.try_again": "Try again",
  "panel.git_diff.not_a_repo": "Not a git repository.",
  "panel.git_diff.clean": "No changes — the working tree is clean.",
  "panel.git_diff.no_file_diff": "No diff available for this file.",
  "panel.git_diff.refresh": "Refresh",
  "panel.git_diff.title": "Git diff",
  "panel.git_diff.close": "Close",
  "panel.git_diff.close_panel": "Close git diff",
  ...
  "settings.debug_bind_address": "Bind address: {address}",
  ...
  "settings.debug_server_config_path": "Config path: {path}",
  "settings.debug_server_platform": "Platform: {platform}",
  "settings.debug_server_workspaces": "Workspaces: {count}",
  ...
  "settings.notification_sounds.category.alerts": "Alerts",
  "settings.notification_sounds.category.bip_bops": "Bip-bops",
  "settings.notification_sounds.category.nopes": "Nopes",
  "settings.notification_sounds.category.staplebops": "Staplebops",
  "settings.notification_sounds.category.yups": "Yups",
  "settings.notification_sounds.event.permission_asked": "Permission needed",
  "settings.notification_sounds.event.permission_asked_desc": "The model needs approval to run a tool.",
  "settings.notification_sounds.event.question_asked": "Question asked",
  "settings.notification_sounds.event.question_asked_desc": "The model is waiting for your answer.",
  "settings.notification_sounds.event.task_completed": "Task complete",
  "settings.notification_sounds.event.task_completed_desc": "The model finished responding.",
  "settings.notification_sounds.event.task_failed": "Task failed",
  "settings.notification_sounds.event.task_failed_desc": "The session stopped with an error.",
  "settings.notification_sounds.master": "Play notification sounds",
  "settings.notification_sounds.master_desc": "Chimes play for session events even while OpenWork is in focus, without showing native notifications.",
  "settings.notification_sounds.none": "None",
  "settings.notification_sounds.preview": "Preview sound",
  "settings.notification_sounds.section_desc": "Sound-only chimes for session events, separate from native notifications. Each event can use a different sound.",
  "settings.notification_sounds.title": "Notification sounds",
  ...
  "settings.expand_reasoning": "Expand reasoning",
  "settings.expand_reasoning_desc": "Open thinking blocks expanded by default instead of collapsed.",
  "settings.expand_tool_results": "Expand tool results",
  "settings.expand_tool_results_desc": "Open tool result groups expanded by default so command output is visible without clicking.",
